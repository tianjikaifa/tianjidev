...
from tianji.config.zi_wei_dou_shu.nian_xi_zhu_xing_biao_module import nian_gan_xing_biao, si_hua_xing_biao, nian_zhi_xing_biao, \
    Tian_Cai_Tian_Show_xing
from tianji.config.zi_wei_dou_shu.nian_xi_zhu_xing_biao_module import Jie_Kong_Xing, Xun_Kong_Xing, Tian_Shang_Tian_Shi_Xing
