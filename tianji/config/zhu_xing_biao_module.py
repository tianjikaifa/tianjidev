...
#     },
# }
json_file = os.path.join(os.path.dirname(__file__), "jsonfile", "bei_dou_zhu_xing_biao.json")
...
#         "破军": "酉"},
# }
json_file = os.path.join(os.path.dirname(__file__), "jsonfile", "nan_dou_zhu_xing_biao.json")
