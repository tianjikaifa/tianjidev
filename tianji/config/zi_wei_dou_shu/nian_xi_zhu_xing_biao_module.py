...
json_file = os.path.join(os.path.dirname(__file__), "../../data/jsonfile", "nian_gan_xing_biao.json")
nian_gan_xing_biao = None
with open(json_file, "r", encoding="utf-8") as f:
    nian_gan_xing_biao = json.load(f)

json_file = os.path.join(os.path.dirname(__file__), "../../data/jsonfile", "si_hua_xing_biao.json")
si_hua_xing_biao = None
with open(json_file, "r", encoding="utf-8") as f:
    si_hua_xing_biao = json.load(f)

json_file = os.path.join(os.path.dirname(__file__), "../../data/jsonfile", "nian_zhi_xing_biao.json")
...
class Jie_Kong_Xing:
    def __init__(self, nian_gan):
        ...
        json_file = os.path.join(os.path.dirname(__file__), "../../data/jsonfile", "jie_kong_biao.json")
        jie_kong_biao = None
        with open(json_file, "r", encoding="utf-8") as f:
...
class Xun_Kong_Xing:
    def __init__(self, nian_gan, nian_zhi):
        self.__nian_gan = nian_gan
        self.__nian_zhi = nian_zhi
        json_file = os.path.join(os.path.dirname(__file__), "../../data/jsonfile", "xun_kong_biao.json")
        xun_kong_biao = None
        with open(json_file, "r", encoding="utf-8") as f:
