...
class Liu_Nian_Xing:
    def __init__(self, nian_zhi):
        ...
        # 安流年将前诸星表
        json_file = os.path.join(os.path.dirname(__file__), "jsonfile", "jiang_xing_biao.json")
        with open(json_file, "r", encoding="utf-8") as f:
            self.jiang_xing_biao = json.load(f)

        json_file = os.path.join(os.path.dirname(__file__), "jsonfile", "sui_jian_biao.json")
        with open(json_file, "r", encoding="utf-8") as f:
